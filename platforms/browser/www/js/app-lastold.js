    ...
    success:function(datares){
      ...
      if(tot_ints==0){
        ...
        for(var i=0;i<tot_ints;i++){
          ...
          reslist+='</div><div class="item-cell"><button class="col button button-small btn-goutline text-uppercase font-9 w-auto mt-5 float-left" onclick="Add_FieldVisit('+csd_id+','+"'"+comp_name+"'"+')"><i class="f7-icons font-12">add</i></button><span id="view_'+i+'"></span></div></div></div></a></li>';
    ...
    success:function(viewCompres){
      ...
      if(det_rslt[0].cm_complain=='Customer'){
        ...
        for(var h=0;h<det_cust.length;h++){
          ...
          cust_comp_div+='<div class="w-100 mt-5"><div class="light-orange w-15 d-inline mr-5 mt-0 float-left mb-1" ><label class="item-checkbox item-content"><input type="checkbox" name="customer[]" value="'+cust_ct_id+'" '+chked_cust+'><i class="icon icon-checkbox"></i></label></div> <div class="light-orange w-80 d-inline mb-1"><div class="accordion-item accordion-item-opened"><a href="#" class="item-content item-link"><div class="item-inner"><div class="item-title grey-txt font-12 fw-500">'+cust_ct_name+'</div></div></a><div class="accordion-item-content nobgclr elevation-10"><div class="block"><span class="font-12" id="customer_txtnm_'+h+'"></span>';           
  ...
  $.ajax({
    ...
    success:function(search_res){      
      ...
      if(list_search.length == 0){
        search_data+='<tr><td class="text-capitalize text-center redtxt font-12">No data found</td><td></td></tr>';
