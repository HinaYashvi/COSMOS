    ...
    success:function(pro_res){
      ...
      if(json_list.length==0){
        ...
        for(var i=0;i<json_list.length;i++){
          ...
          if(cand_email!=''){
            var email = '<br/><span class="text-muted "><i class="f7-icons font-14">envelope_fill</i>&nbsp;:&nbsp<span class="text-lowercase">'+cand_email+'</span></span><br/>';
          }else{
            var email = '';
          }
          ...
          prolist+='<tr class="tr-border" id="pro_tr'+i+'"><td class="text-uppercase fw-600 font-10"><a class="" href="#">'+cand_fname+'</a><br/>'+cont+''+email+'<div id="btn_'+i+'"></div></td></tr>';
